...
#      Что бы открыть ее нужно нажать Terminal | Open new Terminal,
#   и будет слева
...
#
# **Что такое валидация?**
# - Проверка качества и правильности кода, проверка стиля и ошибок
# в том числе лминтерами
#
# ---
#
...
# - Python перестал работать во время выполнения программы из-за ошибки.
