...
# посмотреть на содержимое словаря uploaded
uploaded
# -
...
# режим 'r' (чтение) используется по умолчанию, поэтому его можно не указывать явно
f1 = open("/content/train.csv", encoding="utf-8")  # pylint: disable=consider-using-with
...
# +
# снова откроем файл
f2 = open("/content/train.csv", encoding="utf-8")  # pylint: disable=consider-using-with
