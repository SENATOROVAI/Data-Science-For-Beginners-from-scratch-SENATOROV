...
`git stash save "Мои временные изменения"` - Она в отличие от кнопки в github desktop ещё может сохранить наш стэш под определённым названием и мы сможем в любой момент восстановиться, в отличие от github desktop, если мы случайно нажмём здесь discard
