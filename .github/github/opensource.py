...
# Второе "изменение" — это техническое изменение последней строки файла, которое произошло автоматически из-за редактирования.
...
# Судя по тому что закурыто ишьюсов 1423то достаточно быстро
# Ведётся ли активное обсуждение ишью?
# да, последнее 11 часов назад
