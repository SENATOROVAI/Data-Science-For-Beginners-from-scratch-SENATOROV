...
# 1) в чём отличия классов и экземпляров
# 2) как определить класс
# 3) как инициализировать экземпляр класса
# 4) как определить методы класса и методы экземпляра
# 5) как одни классы наследуются от других

# 1) Класс - абстрактная логическая структура, описывающая
...
# 5) через конструкцию class 'ИмяКласс'(Имя родительского класса)
