...
# +
# элементами списка могут, в частности, быть числа, строки, другие списки
# и словари
...
# +
# students = ["Svetlana", "Andrey", "Luda", "Ruslan", "Dima"]
...
# +
# set_of_numbers = [12, 15, 54, 98, 3, 14, 47, 19, 89, 27, 14, 11]
# set_of_numbers.sort()
# set_of_numbers
...
# +
# кроме того мы можем найти минимальное и максимальное
...
# names = ["Тахир", "Тимур", "Тигран", "Борис", "Виктор", "Геннадий"]
...
# +
# пустой кортеж можно создать с помощью пустых
...
# В кортеже нельзя изменить элемент,  как мы делали в списке.

# +
# для изменения элемента кортеж вначале нужно
...
# +
# tuple_my = (11, 15, 17, 19, 23, 25, 29)
# tuple_my = list(tuple_my)
# tuple_my[5] = 31
# tuple_my

# +
# кортеж из одного элемента можно создать с помощью
# запятой
# let_a = ("a",)
# type(let_a)
...
# +
# shopping_dict = {"onion": 10, "potato": 12, "apple": 24, "orange": 30}
...
# +
# предположим, что мы хотим создать множество делителей числа 24
...
# +
# добавим числа 7 и 11 методом .update()
# factors.update([7, 11])
# factors

# +
# удалить число можно методом .remove()
# factors.remove(7)
# factors
# -
...
# +
# два множества равны, если содержат одинаковые
...
# +
# найдем тех, кто работает или в cv, или в nlp, но не
