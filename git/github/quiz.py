...
#
# https://github.com/MatveyNikiforov/Data-Science-For-Beginners-from-scratch-SENATOROV
...
#
# https://github.com/MatveyNikiforov/Data-Science-For-Beginners-from-scratch-SENATOROV/tree/dev
#
...
#
# Fexes/Closes URL_на_isses/номер_issues
#
# > Какие практики принято соблюдать при создании commit чтобы закрыть автоматический issues?
#
# В названии вставить ссылку на issues, в description вставить closes ссылка_на_isses
#
# > 3.2 Как отклонить/закрыть пул реквест? (предоставьте скриншот где это в гитхабе)
#
# ![pull_request_image.png](attachment:pull_request_image.png)

# > 3.3 Перед отправкой пул реквеста нужно ли создавать ишьюс?
#
# При создании пул реквеста создание issues не обязательно
#
...
#
# нажать на кнопку Compare and pull request
#
...
#
# нужно изменить свою ветку так, чтобы исключить конфликты, для этого можно либо пребазировать свою ветку относительно целевой ветки, либо слить целевую ветку в свою
#
# > Отрывки кода
#
# > 5 Что нужно сделать Для добавления отрывка кода в комментарии к ишьюсу? (Рисунок 104)
#
# обрамить обратными кавычками
#
...
#
# если появится уведомление "Запрос имеет конфликты слияния"
#
...
#
# это первый файл, который может быть в любом формате, нужен для поддержания актуальной информации о проекте для новичков
#
# > 9.1 Что такое и зачем нужен файл CONTRIBUTING (Рисунок 122)
#
# второй файл с любым расширением, GitHub будет показывать ссылку на него при создании любого запроса на слияние. В нем можно указать конкретные вещи, которые мы хотим или не хотим видеть в запросах на слияние
#
# > Управление проектом
#
...
#
# файл, который хранит в себе названия других файлов, которые git игнорирует по умолчанию и не видит, но не удаляет
