...
#   Зайти в GitHub Desktop и нажать кнопку "Fetch origin", перейти в раздел
# "History", выбрать самый верхний "коммит", открыть в IDE.
#
...
#  При нажатии правой кнопки мыши на коммит появляется
# следующие контекстное меню:
#  - Amend commit;
#  - Reset to commit;
#  - Checkout commit;
#  - Reorder commit;
...
#
#   - GitHub desktop -> History -> вызвать правой кнопкой мыши контекстное
# меню -> View on GitHub;
#   - Tg -> группа "HomeWork".
#
...
#   Изменения попадают в "Changes". Перемещаем их в "Staged Changes" с помощью
# кнопки +, вводим сообщение коммита и нажимаем "Commit". Для отправки на
# GitHub нажимаем "Push".
#
# 9) Как посмотреть что коммит точно отправлен и находится в github?
#   Требуется проверить историю в "GitHub Desktop" или использовать команду
# "git log" в терминале IDE.
#
...
#   Ввести команду в терминале "pre-commit run --all-files" -> появится список
# линтеров -> если линтер не прошел проверку, то отобразится сообщение
# "Failed".
#
...
#
# 18) Что такое линтер?
#   Программа для проверки кода на соответствие стандартам, которая выявляет
# ошибки.
#
...
# находится в модуле?
#   Описание модуля — это докстринг в начале файла, кратко описывающий его
# содержимое.
#
# 21.1) С какой git-команды начинается утро программиста?
#   Обычно с команды "git pull" или "git fetch" для обновления локального
# репозитория.
#
# 22) После внесения изменений в файлах, кнопка open in vs code пропадает в
# кошке, как по другому открыть vs code из кошки?
#   Current repository -> правой кнопкой мыши открыть контекстное меню -> Open
# in IDE.
#
# 23) Что такое stash?
...
#   Одновременное редактирование одного и того же файла несколькими
# пользователями.
#
...
#   Необходимо загрузить файлы в свой локальный репозиторий и открыть оба
# файла в IDE, произвести сравнение и выбрать подходящий вариант реализации
# кода.
#
...
#   - программа для установки, настройки, удаления пакетов (расширений,
# плагинов) ПО.
#
# 3) Почему расширение py лучше чем ipynb?
#   pynb-файлы лучше подходят для задач, где важны интерактивность и
# визуализация, а py-файлы — для проектов, требующих более структурированного
# подхода.
#
# 4) Что такое pep8?
...
#   В случае использования snake_case, а так-же приватные атрибуты класса
# всегда начинаются с символа _ (стр.87).
#
...
#     file -> preferences -> vs code settings -> ввести в поиске: Wrap ->
# World Wrap.
#
...
#     Он локальный, в нём можно посмотреть историю изменений файлов и
...
#     У каждой ячейки в правом нижнем углу есть кнопка, которая вызывает
# контекстное меню с выбором языков программирования
#
...
# LIST?
# 21. Вы ознакомились с https://t.me/c/1937296927/832/19307? и  https://github.
