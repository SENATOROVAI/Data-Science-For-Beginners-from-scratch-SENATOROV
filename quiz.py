...
# Файл, который содержит дату урока и что мы запомнили в течение урока.
#
...
#     1. Flake8 - проверяет синтаксис, ошибки стиля (PEP8) и простые баги.
#     2. Pylint - проверяет: ошибки в коде, стиль (PEP8), дублирование, неиспользуемые переменные
#     3. Mypy - проверяет корректность type hints (аннотаций типов).
#     4. Pyright - проверяет аннотации типов (как и MyPy).
#     5. Black - делает единый стиль кода (PEP8).
#     6. Pydocstring - автоматически вставляет шаблон описания функций/классов.
#
...
#   git командa(подсказка: https://t.me/c/1937296927/3602/19531): git stash "NAME_STASH"
#
