...
# - Заходим в github desktop и нажимаем на fetch origin,затем зашли в History посмотрели коммиты,верхние самые свежие, и
...
# - В Githab desktop на файле, где есть конфликт будет восклицательны знак(Conflicted), нажимаем правой кнопкой мыши и открываем файл в VCCode
#
...
# - На панеле сбоку есть три круглишка (Sourse control) нажмём и перейдем и провалимся в commits. Там можно отправлять коммиты (кнопка push), принимать ДЗ(кнопка Pull).
#
